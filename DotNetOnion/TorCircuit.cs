...
namespace DotNetOnion
{
    public class TorCircuit
    {
        ...
        public delegate void StreamDataReceived(CellRelayPlain cell);
        public ConcurrentDictionary<ushort, StreamDataReceived> StreamDataHandlers = new();
        ...
        private static ushort RegisterCircuitId(TorGuard guard, CircuitDataReceived preCreateHandler)
        {
            ...
            for (var i = 0; i < MaxCircuitIdGenerationRetry; i++)
            {
                ...
                var tempId = IntegerHelper.ToUInt16BigEndian(randomBytes);
