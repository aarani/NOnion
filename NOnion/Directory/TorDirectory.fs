...
type TorDirectory =
    ...
    static member Bootstrap (nodeEndPoint: IPEndPoint) (directoryPath: string) =
        async {
            let! networkStatus =
                ...
                async {
                    if String.IsNullOrWhiteSpace directoryPath then
                        ...
                        let consensusPath =
                            Path.Combine(directoryPath, "consensus.txt")
    ...
    static member BootstrapAsync
        ...
        TorDirectory.Bootstrap nodeEndPoint directoryPath |> Async.StartAsTask
