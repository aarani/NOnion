...
module CommandsHelper =
    ...
    let GetCell (command: byte) (reader: BinaryReader) : ICell =
        ...
        | CellVersionCommand -> CellVersions.Deserialize reader
        | CellNetInfoCommand -> CellNetInfo.Deserialize reader
        | CellCreateFastCommand -> CellCreateFast.Deserialize reader
        | CellCreatedFastCommand -> CellCreatedFast.Deserialize reader
